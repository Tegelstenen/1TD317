...
// ======================= Globala variabler =======================
// =================================================================
string path = "/Users/filipsjostrand/Documents/sommarkurser/uppsala/filer/resa.txt";
int const MAX_PERSONER = 10;
int const MAX_TRANSAKTIONER = 30;
...
string Transaktion::hamtaKompis(int index) {
    //
